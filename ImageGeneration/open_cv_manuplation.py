...
def put_text_on_image(img,name,company,date,message):
    ...
    cv2.putText(img,message,(306,400),cv2.FONT_HERSHEY_PLAIN,1,(0,0,51),2)
...
message = "This certificate is given to Trainee to indicate\n that they finished their challenge successfully"
put_text_on_image(img,"Fanuel Abebe","10 Academy","January 10, 2024",message)